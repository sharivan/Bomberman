/*
 * 
 * Módulo usado para configuração do jogo.
...
namespace Bomberman
{
    ...
    {
        // Tick rate
        public static readonly float TICKRATE = 32; // Representa o número de frames por segundo processados pelo engine. Definida por padrão como 32 ciclos por segundo (32 Hz)
        ...
        public static readonly float DEFAULT_FPS = 30; // FPS padrão da animação do jogo. Representa a quantidade de quadros por segundo que será renderizado na tela por cada sprite composto de animações.
        ...
        public static readonly int CELL_SIZE = 64; // Medida do lado do quadrado de cada célula (elemento da matriz) do jogo
        public static readonly Box2D CELL_BOX = new Box2D(Vector2D.NULL_VECTOR, Vector2D.NULL_VECTOR, new Vector2D(CELL_SIZE, CELL_SIZE));
        ...
        public static readonly float DEFAULT_CLIENT_WIDTH = COL_COUNT * CELL_SIZE; // Tamanho padrão da largura do retângulo do jogo
        public static readonly float DEFAULT_CLIENT_HEIGHT = ROW_COUNT * CELL_SIZE; // Tamanho padrão da altura do retângulo do jogo
        ...
        public static readonly RectangleF DEFAULT_TOP_PANEL_RECT = new RectangleF(DEFAULT_DRAW_ORIGIN.X, DEFAULT_DRAW_ORIGIN.Y, DEFAULT_CLIENT_WIDTH, CELL_SIZE);
        public static readonly Box2D DEFAULT_TOP_PANEL_BOX = new Box2D(DEFAULT_TOP_PANEL_RECT);
        public static readonly Box2D DEFAULT_LEVEL_BOX = CELL_BOX.ScaleRight(2) - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_LIVES_IMG_BOX = CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 2 - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_LIVES_BOX = CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 3 - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_SCORE_BOX = (CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 4).ScaleRight(3) - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_TIME_BOX = (CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 7).ScaleRight(2) - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_BOMBS_IMG_BOX = CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 9 - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_BOMBS_BOX = CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 10 - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_FIRE_IMG_BOX = CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 11 - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_FIRE_BOX = CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 12 - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_HEART_IMG_BOX = CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 13 - CELL_SIZE / 8;
        public static readonly Box2D DEFAULT_HEART_BOX = CELL_BOX + Vector2D.RIGHT_VECTOR * CELL_SIZE * 14 - CELL_SIZE / 8;
        public static readonly RectangleF DEFAULT_GAME_AREA_RECT = new RectangleF(DEFAULT_DRAW_ORIGIN.X, DEFAULT_DRAW_ORIGIN.Y + CELL_SIZE, DEFAULT_CLIENT_WIDTH, DEFAULT_CLIENT_HEIGHT - CELL_SIZE);
